...
export class TemplateEngine {
  ...
  private evaluateExpression(expression: string, book: BookMetadata & Record<string, any>): string {
  ...
  private getFieldValue(fieldName: string, book: BookMetadata & Record<string, any>): string {
